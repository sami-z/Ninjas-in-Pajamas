...
/**
 * This class is the controller for the WeeklySavings.fxml scene, it takes in the information about
 * weekly savings from FinanceCalculatorController and displays it in the scene.
 */
...
public class weeklySavingsController {
	...
	/**
	 * This method sets the sets the text in WeeklySavings to the calculation that we want
	 * to display
	 * 
	 * @param s - The string containing the weekly savings calculation
	 */
